...
These functions provide high-level wrappers for Blender's internal
...
def import_stl(
        ...
        **Important:**
        ...
        if apply_scale:
                ...
                apply_transforms(obj, location=False, rotation=False, scale=True)
...
def DEPR_apply_scale_transform(obj: bpy.types.Object) -> None:
